...
class AccountTest(TestCase):
	...
	def test_thatAccout_canBeDeposited_into_afterCreation(self):

		amount = 500.0

		self.assertEqual(0.0, check_balance())
	...
	def test_DepositTwice_thatAccountCanBeDeposited_twice(self):
...
`		self.assertEqual(5500.0, check_balance(second_balance))
	...
	def test_depositeNegativeAmount_balanceRemain_unchanged(self):
